<div
	class="flex flex-col justify-center items-center h-screen w-full bg-gradient-to-r from-indigo-500 to-indigo-950"
>
	<div
	...
	>
		<div class="w-full">
			<div class="text-center">
				<h1 class="text-3xl font-semibold text-gray-900">Crie sua conta</h1>
			</div>
			<div class="mt-5">
				<form method="POST">
