<div class="flex flex-col justify-center items-center h-screen w-full bg-gradient-to-r from-indigo-700 to-indigo-950">
    <!-- this should be a card component that will contain the form-->
        ...
        <div class="w-full">
            <div class="text-center">
                ...
                <p class="mt-2 text-gray-500">Faça login abaixo para acessar sua conta</p>
            </div>
            <div class="mt-5">
                <form method="POST">
                    <div class="relative mt-6">
                        <input type="email" name="email" id="email" placeholder="Email Address" class="peer mt-1 w-full border-b-2 border-gray-300 px-0 py-1 placeholder:text-transparent focus:border-gray-500 focus:outline-none" />
                    ...
                    <div class="my-6">
                        <button type="submit" class="w-full rounded-md bg-black px-3 py-4 text-white focus:bg-gray-600 focus:outline-none">Enviar</button>
                    </div>
                    <p class="text-center text-sm text-gray-500">Ainda não possui uma conta?
                        <a href="/novo"
                            class="font-semibold text-gray-600 hover:underline focus:text-gray-800 focus:outline-none">Crie sua conta</a>.
                    </p>
                </form>
            </div>
        </div>
